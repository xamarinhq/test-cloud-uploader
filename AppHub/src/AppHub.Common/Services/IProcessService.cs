...
namespace Microsoft.AppHub.Common
{
    ...
    public interface IProcessService
    {
        ...
        /// <remarks>
        /// The returned ProcessResult contains merged standard output and standard error, but they are not available until the launched process
        /// finishes execution. The optional callbacks allow the caller to be notifed about new output while the process is running.
        /// As an alternative design, I considered using IObserver for notifications. However, the Reactive Extensions are not yet available for .NET Core. Also,
